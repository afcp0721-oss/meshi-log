...
import emailScript from '../email-auth.js';
...
export default {
  async fetch(request, env, ctx) {
    ...
    } else if (request.method === 'GET' && url.pathname === '/email-auth.js') {
      response = new Response(emailScript, {headers: {'Content-Type': 'application/javascript; charset=utf-8'}});
    } else {
